...
__tidycensus__ is an R package that allows users to interface with the US Census Bureau's decennial Census and five-year American Community APIs and return tidyverse-ready data frames, optionally with simple feature geometry included.  Install from GitHub with the following command: 
...
To keep up with on-going development of __tidycensus__ and get even more examples of how to use the package, subscribe to my email list below (no spam, I promise!).  You'll also get updates on the development of my upcoming book, _Analyzing the US Census with R_.  
...
I'm planning a CRAN release after I get the first round of feedback from users and continue testing.  My development focus is on making the current datasets as accessible as possible; if you need other approaches or datasets, I recommend the [censusapi](https://github.com/hrecht/censusapi) and [acs](https://cran.r-project.org/web/packages/acs/index.html) packages.
