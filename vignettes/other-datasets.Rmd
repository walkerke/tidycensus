...
The two core functions implemented in __tidycensus__ are `get_decennial`, which grants access to the 1990, 2000, and 2010 decennial US Census APIs, and `get_acs`, which grants access to the 5-year American Community Survey APIs.  In this basic example, let's look at median gross rent by state in 1990: 
