...
We notice that there are four entries for each Census tract, with each entry representing one of our requested variables. The `summary_var` column represents the value of the summary value, which is total population in this instance.  When a summary variable is specified in `get_acs`, both `summary_est` and `summary_moe` columns will be returned.  
