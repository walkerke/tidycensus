...
__Please note: until version 1.0 of tidycensus is published on CRAN, this functionality is only available in the development version of tidycensus.  Install the development version with `remotes::install_github("walkerke/tidycensus")`.__
