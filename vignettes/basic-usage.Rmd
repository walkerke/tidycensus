...
There are two major functions implemented in __tidycensus__: `get_decennial()`, which grants access to the 2000 and 2010 decennial US Census APIs, and `get_acs()`, which grants access to the 1-year and 5-year American Community Survey APIs.  
